    ...
    <div className="min-h-screen flex items-center justify-center bg-surface px-gutter">
      <div className="w-full max-w-[28rem] bg-surface-container-lowest border border-outline-variant rounded-xl p-lg shadow-md">
        <div className="text-center mb-lg">
          <h1 className="font-headline-md text-headline-md text-on-surface mb-1">Crear cuenta</h1>
          <p className="font-body-sm text-body-sm text-on-surface-variant">Empieza a organizar tu búsqueda de empleo</p>
        </div>
        ...
        <form className="flex flex-col gap-md" onSubmit={handleSubmit(onSubmit)} noValidate>
          <div className="flex flex-col gap-sm">
            <label className="font-label-md text-label-md text-on-surface" htmlFor="name">Nombre</label>
            <input
              id="name"
              type="text"
